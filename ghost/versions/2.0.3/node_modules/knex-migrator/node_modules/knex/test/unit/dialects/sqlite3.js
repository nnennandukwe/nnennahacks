...
describe('Unit: Sqlite3 - renameColumn', function() {
    it('[backwards compatible] can rename column with double quotes', function () {
        ...
        const sql = 'CREATE TABLE "accounts" ("id" varchar(24) not null primary key, "about" varchar(24))';

        const newSql = ddl._doReplace(sql, '`about`', '`about_me`');
        newSql.should.eql('CREATE TABLE "accounts" ("id" varchar(24) not null primary key, "about_me" varchar(24))');
    });
